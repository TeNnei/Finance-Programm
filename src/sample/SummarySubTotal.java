...
public class SummarySubTotal {
    public static final String TABLE_OF_SUBTOTAL = "summary_subtotal";
    public static final String CODE = "code";
    public static final String SALDO_IN_SOM = "saldo_in_som";
    public static final String DEBET_SOM = "debet";
    public static final String KREDIT_SOM = "kredit";
